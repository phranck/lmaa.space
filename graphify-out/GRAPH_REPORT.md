...
## Corpus Check
- 823 files · ~649,332 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 31298 nodes · 35806 edges · 1604 communities (1505 shown, 99 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 369 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f184eec4`
...
## Communities (1604 total, 99 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (110): extractEuropeanPostalCodePrefix(), normalizePostalQuery(), POSTAL_PATTERNS, PostalPattern, parseCountryFilter(), parseRegionFilter(), ShopFilterParams, shopFilterSchema (+102 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (100): categories, shopGeoCities, shopGeoCountries, shopGeoRegions, shopHeadquarters, submissionCategories, submissionHeadquarters, getRecord() (+92 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (65): db, EmailTemplateInsert, extractRecipientAddress(), isEmailRecipient(), ESCAPE_MAP, escapeHtml(), formatReviewCost(), getAdminStatsRow() (+57 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (81): authRoutes, inviteAcceptLimit, inviteLookupLimit, uiPreferencesSchema, backgroundErrorsRoutes, categoriesRoutes, focalPointSchema, unsplashImageSchema (+73 more)
...
Cohesion: 0.07
Nodes (40): @/components/ContentArticle.astro, @/components/HeroLogo.astro, @/layouts/BaseLayout.astro, apiGet(), buildContentDescription(), ContentPageView, emptyRejectedShopsResponse(), getContentWidthClass() (+32 more)
...
Cohesion: 0.04
Nodes (57): adminRoutes, env, envSchema, AppliedMigrationRow, ExistingColumnRow, ExistingObjectRow, formatMigrationRef(), loadAppliedMigrations() (+49 more)

### Community 13 - "Community 13"
Cohesion: 0.07
Nodes (52): @/components/UnsplashAttribution.astro, @/components/Footer.astro, @/components/Header.astro, safeProfileUrl, UnsplashAttribution(), UnsplashAttributionProps, PublishedShopName(), renderSupportLadderProse() (+44 more)
...
Cohesion: 0.17
Nodes (25): asIntervalKey(), childrenOf(), ContentShortcodeSegment, getStringParam(), isFlagSet(), isRenderableRejectedShopsTable(), isRenderableSupportLadder(), normalizePageSize() (+17 more)
...
Cohesion: 0.04
Nodes (48): name, notNull, primaryKey, type, application_url, cookie_duration, program_found, program_url (+40 more)
...
Cohesion: 0.04
Nodes (46): commission, compensation_model, cookie_duration, network_program_url, notes, program_url, recommendation, requirements (+38 more)
...
Cohesion: 0.06
Nodes (30): usePersistedTextareaHeight(), ImportResult, useAdminSubmission(), useAdminSubmissions(), useDeleteSubmission(), useEditSubmission(), useImportSubmissions(), useReviewSubmission() (+22 more)
...
Cohesion: 0.05
Nodes (43): ControlTriggerProps, ControlTriggerSize, EMPTY_DISABLED_VALUES, ListboxContext, ListboxContextValue, ListboxDismissalParams, ListboxKeyboardNavigationParams, ListboxOptionProps (+35 more)

### Community 198 - "Community 198"
Cohesion: 0.03
Nodes (86): AdminUser, AdminUserAccountTemplateChoiceInsert, AdminUserInsert, AppSetting, appSettings, BackgroundError, backgroundErrors, CategoryInsert (+78 more)
...
Cohesion: 0.10
Nodes (30): insertBackgroundError(), deletePushSubscriptionById(), getPushSubscriptionsByAdminId(), advanceReminderDate(), claimDueReminders(), deleteReminderById(), buildBackgroundErrorContext(), buildObjectErrorMessage() (+22 more)
...
Cohesion: 0.08
Nodes (20): UiPreferences, useUpdateUiPreferences(), useDeadLinkReports(), useDeleteShopFromDeadLinks(), useDismissDeadLink(), QUERY_KEY, useMarkdownWidgets(), useSaveMarkdownWidgets() (+12 more)
...
Cohesion: 0.21
Nodes (10): getPaymentMethodLabel(), PAYMENT_METHOD_DISPLAY_ORDER, PAYMENT_METHOD_DISPLAY_PRIORITY, PAYMENT_METHOD_MAP, PAYMENT_METHOD_METADATA, PaymentMethodDef, PaymentMethodIconProps, PaymentMethodLocale (+2 more)
...
Cohesion: 0.05
Nodes (66): addHeroImageSchema, focalPointSchema, heroRoutes, rotationIntervalSchema, rotationSchema, toggleSelectedSchema, unsplashDownloadSchema, unsplashRoutes (+58 more)
...
Cohesion: 0.05
Nodes (50): cx(), COUNTRY_DISPLAY_NAMES, CountryCodeOption, EUROPEAN_COUNTRY_CODES, CountryCodeSelect(), CountryCodeSelectProps, FormField(), FormFieldProps (+42 more)
...
Cohesion: 0.03
Nodes (86): AdminUserAccountTemplateChoice, Category, Shop, SocialMediaAccount, SocialMediaAccountInsert, socialMediaAccounts, SocialMediaPostTemplate, SocialMediaPostTemplateInsert (+78 more)
...
Cohesion: 0.02
Nodes (124): reviewJobRoutes, resolveEffortLevel(), client, ReviewEventRow, reviewEvents, ReviewJobRow, reviewJobs, reviewSpend (+116 more)
...
- **Why does `useI18n()` connect `Community 4` to `Community 9`, `Community 522`, `Community 10`, `Community 1186`, `Community 932`, `Community 424`, `Community 425`, `Community 299`, `Community 49`, `Community 827`, `Community 957`, `Community 830`, `Community 1085`, `Community 192`, `Community 839`, `Community 203`, `Community 988`, `Community 483`, `Community 484`, `Community 233`, `Community 235`, `Community 110`, `Community 113`, `Community 883`, `Community 117`, `Community 1014`, `Community 888`, `Community 505`, `Community 893`?**
...
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.03512596899224806 - nodes in this community are weakly interconnected._
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.033379909951870824 - nodes in this community are weakly interconnected._