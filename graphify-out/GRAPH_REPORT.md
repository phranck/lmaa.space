# Graph Report - WebApp  (2026-08-22)

## Corpus Check
- 820 files · ~646,921 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 31284 nodes · 35788 edges · 1636 communities (1536 shown, 100 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 369 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cb36a229`
...
- `OverlayCard()` --calls--> `resolveOverlayZIndex()`  [INFERRED]
  apps/dashboard/src/components/ui/OverlayCard.tsx → packages/ui/src/overlay-stack.ts
- `readPaymentMethodsFromHtml()` --calls--> `normalizePaymentMethods()`  [INFERRED]
  apps/backend/src/lib/payment-methods-from-html.ts → packages/shared/src/constants/payment-methods.ts
- `mapShopJsonToShopData()` --calls--> `normalizePaymentMethods()`  [INFERRED]
  apps/backend/src/lib/shopjson-mapper.ts → packages/shared/src/constants/payment-methods.ts
- `matchesDomainAlertRule()` --calls--> `parseDomainAlertDomains()`  [INFERRED]
  apps/backend/src/services/domain-alert-rules.ts → packages/contracts/src/domain-alert-rules.ts
- `resolveManagedRedirectUrl()` --calls--> `normalizeRedirectUrlName()`  [INFERRED]
  apps/backend/src/services/redirect-urls.ts → packages/contracts/src/redirect-urls.ts

## Import Cycles
- None detected.

## Communities (1636 total, 100 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (116): shopLikes, extractEuropeanPostalCodePrefix(), normalizePostalQuery(), POSTAL_PATTERNS, PostalPattern, parseCountryFilter(), parseRegionFilter(), ShopFilterParams (+108 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (97): Shop, shopGeoCities, shopGeoCountries, shopGeoRegions, shopHeadquarters, submissionCategories, submissionHeadquarters, getRecord() (+89 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (51): EmailTemplate, EmailTemplateInsert, formSubmissions, extractRecipientAddress(), isEmailRecipient(), ESCAPE_MAP, escapeHtml(), createSubmissionFromFormData() (+43 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (82): authRoutes, inviteAcceptLimit, inviteLookupLimit, uiPreferencesSchema, backgroundErrorsRoutes, categoriesRoutes, focalPointSchema, unsplashImageSchema (+74 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (66): ContentEditorLoadingFallback(), UiPreferences, useUpdateUiPreferences(), CategoryGridItem(), CategoryGridItemProps, useI18n(), EmailTemplateImportConflictDialog(), EmailTemplateImportConflictDialogProps (+58 more)

### Community 5 - "Community 5"
Cohesion: 0.09
Nodes (31): @/components/ContentArticle.astro, @/components/HeroLogo.astro, @/layouts/BaseLayout.astro, apiGet(), buildContentDescription(), ContentPageView, emptyRejectedShopsResponse(), getContentWidthClass() (+23 more)
...
Cohesion: 0.07
Nodes (54): failure, Result, success, acceptInviteWithSession(), CreateOwnerAdminInput, createOwnerAdminWithSession(), createSession(), deleteSession() (+46 more)

### Community 9 - "Community 9"
Cohesion: 0.07
Nodes (26): createHlsUploadBatches(), HLS_UPLOAD_CHUNK_TARGET_BYTES, HlsBundleCompletePayload, MediaBundleUpload, MediaBundleUploadFile, MediaFileUpload, uploadChunkedHlsBundle(), useDeleteMediaAssets() (+18 more)

### Community 10 - "Community 10"
Cohesion: 0.08
Nodes (44): getAdminShopQueryFn(), getAdminShopQueryKey(), ShopReviewImportResult, ShopVisibilityCounts, useAcceptShopReview(), useAdminShop(), useDeleteShop(), useFetchPreviewImage() (+36 more)
...
Cohesion: 0.02
Nodes (77): adminRoutes, bgColor, letter, env, envSchema, db, categories, rateLimitEntries (+69 more)

### Community 13 - "Community 13"
Cohesion: 0.13
Nodes (32): renderSupportLadderProse(), createSafeMarked(), escapeHtml(), extractRenderableShortcodes(), getMediaAliasPosterUrl(), getMediaAliasUrl(), getSafeAspectRatio(), getYoutubeVideoId() (+24 more)
...
Cohesion: 0.04
Nodes (53): name, notNull, primaryKey, type, avatar_url, email, first_name, invite_token_hash (+45 more)
...
Cohesion: 0.04
Nodes (49): name, notNull, primaryKey, type, avatar_url, email, is_owner, last_name (+41 more)
...
Cohesion: 0.04
Nodes (51): name, notNull, primaryKey, type, avatar_url, email, first_name, invite_expires_at (+43 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (49): first_name, invite_expires_at, invite_token_hash, is_owner, last_login_at, last_name, locale, role (+41 more)
...
Cohesion: 0.11
Nodes (31): EURO_EXACT, EURO_WHOLE, groupIban(), QR_DEFAULTS, SupportLadder(), SupportLadderProps, asIntervalKey(), childrenOf() (+23 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (43): ActiveTool, applyTextStyleRange(), applyTextStyleToWholeLayer(), AttributeInput(), AttributeSelect(), CanvasToolbar(), clamp(), cx() (+35 more)

### Community 33 - "Community 33"
Cohesion: 0.06
Nodes (71): addHeroImageSchema, focalPointSchema, heroRoutes, rotationIntervalSchema, rotationSchema, toggleSelectedSchema, socialPreviewImageRoutes, socialPreviewRemoteAssetImportSchema (+63 more)
...
Cohesion: 0.04
Nodes (49): email, first_name, invite_expires_at, invite_token_hash, is_owner, last_login_at, locale, role (+41 more)
...
Cohesion: 0.04
Nodes (53): name, notNull, primaryKey, type, avatar_url, email, invite_expires_at, invite_token_hash (+45 more)
...
Cohesion: 0.05
Nodes (30): FooterBlockConfigPanel(), IconPicker, MarkdownEditor, Props, SocialMediaOrderEditorProps, BLOCK_ABBR, FooterBlockItem(), getBlockLabel() (+22 more)

### Community 50 - "Community 50"
Cohesion: 0.04
Nodes (48): name, notNull, primaryKey, type, avatar_url, email, first_name, is_owner (+40 more)
...
Cohesion: 0.04
Nodes (48): name, notNull, primaryKey, type, application_url, commission, contact_email, cookie_duration (+40 more)

### Community 65 - "Community 65"
Cohesion: 0.04
Nodes (48): name, notNull, primaryKey, type, avatar_url, email, invite_expires_at, invite_token_hash (+40 more)

### Community 66 - "Community 66"
Cohesion: 0.04
Nodes (48): name, notNull, primaryKey, type, application_url, commission, contact_email, program_found (+40 more)

### Community 67 - "Community 67"
Cohesion: 0.04
Nodes (47): commission, compensation_model, cookie_duration, network_program_id, payout_threshold, program_found, program_type, recommendation (+39 more)
...
Cohesion: 0.04
Nodes (48): name, notNull, primaryKey, type, application_url, commission, cookie_duration, payout_threshold (+40 more)

### Community 72 - "Community 72"
Cohesion: 0.05
Nodes (44): name, notNull, primaryKey, type, application_url, compensation_model, payout_threshold, program_found (+36 more)

### Community 73 - "Community 73"
Cohesion: 0.04
Nodes (47): name, notNull, primaryKey, type, application_url, commission, contact_email, program_found (+39 more)

### Community 74 - "Community 74"
Cohesion: 0.04
Nodes (47): name, notNull, primaryKey, type, application_url, contact_email, cookie_duration, network_program_id (+39 more)
...
Cohesion: 0.04
Nodes (47): commission, compensation_model, cookie_duration, notes, recommendation, requirements, scanned_at, shop_id (+39 more)
...
Cohesion: 0.04
Nodes (47): name, notNull, primaryKey, type, application_url, commission, contact_email, cookie_duration (+39 more)
...
Cohesion: 0.05
Nodes (44): name, notNull, primaryKey, type, avatar_url, first_name, invite_token_hash, is_owner (+36 more)
...
Cohesion: 0.05
Nodes (44): created_at, icon, id, image_photographer, image_photographer_url, image_url, name, sort_order (+36 more)

### Community 93 - "Community 93"
Cohesion: 0.04
Nodes (47): name, notNull, primaryKey, type, application_url, commission, contact_email, notes (+39 more)
...
Cohesion: 0.05
Nodes (44): default, name, notNull, primaryKey, type, body_text, footer_banner_url, footer_text (+36 more)
...
Cohesion: 0.13
Nodes (13): ACTIVE_STATES, reviewKey(), useCancelReviewJob(), useReviewJob(), useReviewJobs(), useReviewSpend(), useReviewVerdictBySubmission(), AutomatedChecksTab() (+5 more)

### Community 111 - "Community 111"
Cohesion: 0.05
Nodes (43): dependencies, blueimp-md5, date-fns, @dnd-kit/core, @dnd-kit/sortable, @dnd-kit/utilities, @lmaa/contracts, @lmaa/shared (+35 more)
...
Cohesion: 0.04
Nodes (38): ErrorBoundary, Props, State, I18nContext, I18nContextValue, I18nProvider(), resolveInitialLocale(), AdminLayout (+30 more)
...
Cohesion: 0.05
Nodes (42): dependencies, astro, @astrojs/node, @astrojs/react, @astrojs/sitemap, @formkit/auto-animate, hls.js, @lmaa/contracts (+34 more)

### Community 117 - "Community 117"
Cohesion: 0.22
Nodes (12): resolveDashboardMediaUrl(), BYTE_FORMATTERS, canOpenInBrowser(), FormatBytesOptions, getHlsMarkdownEmbed(), getMediaTypeLabel(), isHlsBundleAsset(), isImageAsset() (+4 more)

### Community 118 - "Community 118"
Cohesion: 0.05
Nodes (41): completed_at, completed_shops, errors, failed_shops, started_at, started_by, status, name (+33 more)
...
Cohesion: 0.18
Nodes (23): CONTENT_PAGE_SUMMARY_FIELDS, ContentPageDetailRow, contentPageSlugExists(), ContentPageStatus, ContentPageSummaryRow, ContentPageWidth, createContentPage(), deleteContentPage() (+15 more)

### Community 141 - "Community 141"
Cohesion: 0.08
Nodes (21): dateFormatter, FormSubmitEvent, PAGE_SIZE_OPTIONS, RejectedShopsTableDataAction, RejectedShopsTableDataState, RejectedShopsTableProps, RejectedShopsTableState, ShopLogo() (+13 more)
...
Cohesion: 0.05
Nodes (39): content, created_by, show_title, slug, title, updated_at, updated_by, default (+31 more)
...
Cohesion: 0.05
Nodes (38): icon, id, image_photographer, image_photographer_url, image_url, name, sort_order, default (+30 more)
...
Cohesion: 0.05
Nodes (39): created_at, icon, image_photographer, image_photographer_url, image_url, sort_order, unsplash_image_id, default (+31 more)
...
Cohesion: 0.08
Nodes (26): MenuContext, MenuContextValue, MenuItemPrimitive(), MenuItemPrimitiveProps, MenuItemPrimitiveSize, MenuItemPrimitiveVariant, MenuOrigin, MenuPosition (+18 more)
...
Cohesion: 0.06
Nodes (35): columnsFrom, columnsTo, name, onDelete, onUpdate, tableFrom, tableTo, columnsFrom (+27 more)

### Community 200 - "Community 200"
Cohesion: 0.06
Nodes (35): content, created_at, show_title, slug, status, title, default, name (+27 more)
...
Cohesion: 0.06
Nodes (22): CategoriesPage(), CategoryEditAction, CategoryEditCard(), CategoryEditCardProps, CategoryEditLabels, CategoryEditState, CategoryFormPanelProps, CategoryImagePanelProps (+14 more)
...
Cohesion: 0.07
Nodes (16): DashboardActionAriaBehavior, DashboardActionButton(), DashboardActionColorRole, DashboardActionIcon, DashboardActionId, DashboardActionLabelKey, DashboardActionStatus, ExportActionButton() (+8 more)

### Community 234 - "Community 234"
Cohesion: 0.10
Nodes (16): fieldTypeLabel(), BuilderActiveDrag, BuilderDragOverlayContent(), BuilderHeaderActionsProps, BuilderSlugBarProps, BuilderSubmissionConfigPanel(), BuilderUIState, BuilderWorkspace() (+8 more)
...
Cohesion: 0.06
Nodes (45): AddressParts, describePhotonFeature(), geocode(), geocodeAddress(), GeocodingResult, NominatimEntry, PhotonResponse, queryNominatim() (+37 more)
...
Cohesion: 0.06
Nodes (33): content, created_by, slug, status, title, updated_by, default, name (+25 more)
...
Cohesion: 0.06
Nodes (33): name, notNull, primaryKey, type, admin_user_id, created_at, data, expires_at (+25 more)
...
Cohesion: 0.06
Nodes (31): import, require, types, dependencies, sqids, zod, devDependencies, tsup (+23 more)
...
Cohesion: 0.14
Nodes (19): outputPath, apiReferenceContentSecurityPolicy, buildOpenApiDocument(), documentedRouteKeys(), excludedPublicRouteKeys, getOpenApiServers(), hasBuiltApiReference(), serveApiReference() (+11 more)

### Community 291 - "Community 291"
Cohesion: 0.07
Nodes (30): nav_id, page_slug, position, target, url, name, notNull, primaryKey (+22 more)

### Community 292 - "Community 292"
Cohesion: 0.11
Nodes (25): buildShapePath(), canvasToBlob(), createId(), createImageLayer(), createShapeLayer(), createTextLayer(), drawImageLayer(), drawLayerFrame() (+17 more)

### Community 293 - "Community 293"
Cohesion: 0.10
Nodes (31): ADMIN_ROLES, REGION_CODES, RegionCode, SHOP_MUTABLE_VISIBILITIES, SHOP_VISIBILITIES, ShopMutableVisibility, ShopVisibility, SUBMISSION_REVIEW_STATUSES (+23 more)

### Community 294 - "Community 294"
Cohesion: 0.09
Nodes (21): buildCodeSamples(), buildPaths(), buildPublicSchemas(), collectComponentSchemaRefs(), errorResponse(), filterParameters, getOperationSampleUrl(), HttpMethod (+13 more)

### Community 295 - "Community 295"
Cohesion: 0.16
Nodes (19): attribute(), collectFontReferences(), CRITICAL_FONT_FILES, EXPECTED_FONT_FILES, extractFontUrls(), fetchChecked(), findCssFiles(), hasRel() (+11 more)

### Community 296 - "Community 296"
Cohesion: 0.16
Nodes (16): BrowserFileSystemDirectoryEntry, BrowserFileSystemDirectoryReader, BrowserFileSystemEntry, BrowserFileSystemFileEntry, BrowserFileSystemFileHandle, collectDroppedHlsBundleItem(), collectEntryFiles(), DirectoryReadProgress (+8 more)

### Community 297 - "Community 297"
Cohesion: 0.08
Nodes (17): likedShops, saveLikedShopsAndUpdateNav(), updateMyShopsNavVisibility(), isShopLiked(), ShopCardProps, ShopCardReact(), ShopCategory, LikedShopsAction (+9 more)
...
Cohesion: 0.08
Nodes (28): id, ip_hash, reason, reported_at, shop_id, name, notNull, primaryKey (+20 more)

### Community 301 - "Community 301"
Cohesion: 0.07
Nodes (28): config, is_active, name, slug, updated_at, name, notNull, primaryKey (+20 more)

### Community 302 - "Community 302"
Cohesion: 0.07
Nodes (28): content, created_by, status, title, updated_by, default, name, notNull (+20 more)
...
Cohesion: 0.10
Nodes (25): deleteReasonUpdateSchema, headquartersSchema, ogImageUpdateSchema, paymentMethodsSchema, previewImageSchema, safeShopUrl, shopBodySchema, shopcheckImportSchema (+17 more)
...
Cohesion: 0.08
Nodes (39): CharCounter(), CharCounterProps, Checkbox(), CheckboxProps, dialogFooterAlignClass, dialogFooterDensityClass, DialogFooterPrimitive(), DialogFooterPrimitiveAlign (+31 more)

### Community 325 - "Community 325"
Cohesion: 0.10
Nodes (19): MARKDOWN_SHORTCODE_TOKENS, MarkdownShortcodeDefinitionToken, MarkdownShortcodeParamType, MarkdownShortcodePlacement, MarkdownShortcodeRenderMode, MarkdownShortcodeTargetRule, SUPPORT_LADDER_BANK_ACCOUNT, SUPPORT_LADDER_CUSTOM (+11 more)

### Community 326 - "Community 326"
Cohesion: 0.19
Nodes (23): FormConfigRow, formConfigs, createFormConfig(), deleteFormConfig(), getActiveFormConfigByName(), getActiveFormConfigBySlug(), getFormConfigByName(), getFormConfigBySlug() (+15 more)
...
Cohesion: 0.12
Nodes (21): isRecord(), normalizeSortState(), parseTableSortFromSearchParams(), readStoredTableSort(), StoredTableSort, SORTABLE_COLUMNS, writeStoredTableSort(), applyShopsVisibilityFilterSearchParam() (+13 more)
...
Cohesion: 0.09
Nodes (19): FOOTER_HEIGHTS_PX, FOOTER_PADDING_Y, FOOTER_PADDING_Y_PX, FooterStyle, footerStyleVars(), resolveFooterHeightPx(), ApiError, ApiResponse (+11 more)
...
Cohesion: 0.08
Nodes (25): dialect, id, columns, concurrently, isUnique, method, name, with (+17 more)
...
Cohesion: 0.08
Nodes (25): ButtonBlock, buttonBlockSchema, FOOTER_HEIGHTS, FOOTER_PADDING_Y, FOOTER_STYLE_DEFAULTS, FooterBlock, footerBlockSchema, FooterColumn (+17 more)

### Community 371 - "Community 371"
Cohesion: 0.08
Nodes (26): exports, ./alert-dialog, ./button-icons, ./button-primitives, ./char-counter, ./choice-primitives, ./country-code-select, ./dashboard-section (+18 more)

### Community 372 - "Community 372"
Cohesion: 0.08
Nodes (25): name, notNull, primaryKey, type, category_id, shop_categories_shop_id_category_id_pk, columns, concurrently (+17 more)
...
Cohesion: 0.08
Nodes (25): nav_items_page_slug_content_pages_slug_fk, columns, concurrently, isUnique, method, name, with, idx_nav_items_nav (+17 more)

### Community 375 - "Community 375"
Cohesion: 0.08
Nodes (25): shop_concern_reports_shop_id_shops_id_fk, columns, concurrently, isUnique, method, name, with, idx_scr_shop (+17 more)
...
Cohesion: 0.08
Nodes (24): dialect, name, id, prevId, checkConstraints, compositePrimaryKeys, foreignKeys, indexes (+16 more)
...
Cohesion: 0.09
Nodes (23): SOCIAL_MEDIA_POST_TEMPLATE_SCOPES, SocialMediaPlatform, SocialMediaPostTemplate, socialMediaPostTemplateCreateSchema, SocialMediaPostTemplateInput, SocialMediaPostTemplateScope, SocialMediaPostTemplateVariable, accountInputBase (+15 more)

### Community 424 - "Community 424"
Cohesion: 0.05
Nodes (32): AuthContext, authMeQueryKey, authSetupQueryKey, AuthState, useAuth(), FormState, InvitePage(), FIELD_IDS (+24 more)
...
Cohesion: 0.09
Nodes (23): config, is_active, name, updated_at, name, notNull, primaryKey, type (+15 more)

### Community 427 - "Community 427"
Cohesion: 0.09
Nodes (22): columns, name, nullsNotDistinct, columns, name, nullsNotDistinct, dialect, id (+14 more)

### Community 428 - "Community 428"
Cohesion: 0.09
Nodes (23): content, slug, status, title, default, name, notNull, primaryKey (+15 more)
...
Cohesion: 0.05
Nodes (40): content, content_width, created_at, created_by, show_title, title, updated_by, default (+32 more)
...
Cohesion: 0.09
Nodes (22): name, notNull, primaryKey, type, admin_user_id, social_media_account_id, template_id, updated_at (+14 more)
...
Cohesion: 0.16
Nodes (17): useDeleteShopReminder(), useSetShopReminder(), useShopReminder(), RECURRENCE_LABELS, RECURRENCE_OPTIONS, UNIT_OPTIONS, WEEKDAYS, buildCustomSummary() (+9 more)

### Community 484 - "Community 484"
Cohesion: 0.12
Nodes (17): BACKGROUND_ERRORS_KEY, BackgroundErrorFilters, BackgroundErrorRow, useBackgroundErrors(), useDeleteBackgroundError(), useResolveBackgroundError(), BACKGROUND_ERROR_DETAIL_LABELS, BACKGROUND_ERROR_DETAIL_ORDER (+9 more)

### Community 485 - "Community 485"
Cohesion: 0.10
Nodes (21): key, value, name, notNull, primaryKey, type, checkConstraints, columns (+13 more)
...
Cohesion: 0.10
Nodes (17): AlertDialog(), AlertDialogProps, AlertVariant, variantIcons, ButtonPrimitive(), ButtonPrimitiveProps, ButtonPrimitiveSize, ButtonPrimitiveVariant (+9 more)

### Community 488 - "Community 488"
Cohesion: 0.11
Nodes (19): dependencies, @anthropic-ai/sdk, @atproto/api, @aws-sdk/client-s3, bcryptjs, drizzle-orm, fflate, hono (+11 more)
...
Cohesion: 0.09
Nodes (33): pushSubscriptions, insertBackgroundError(), deletePushSubscriptionByEndpoint(), deletePushSubscriptionById(), getPushSubscriptionsByAdminId(), upsertPushSubscription(), advanceReminderDate(), claimDueReminders() (+25 more)

### Community 491 - "Community 491"
Cohesion: 0.10
Nodes (19): dialect, id, idx_nav_items_nav, prevId, checkConstraints, compositePrimaryKeys, indexes, isRLSEnabled (+11 more)
...
Cohesion: 0.11
Nodes (19): shop_categories_shop_id_category_id_pk, columns, concurrently, isUnique, method, name, with, idx_sc_category (+11 more)
...
Cohesion: 0.15
Nodes (12): FooterBuilderWorkspace(), ensureConfig(), MarkdownEditor, StepRow(), StepRowProps, SubmissionConfigPanel(), SubmissionConfigPanelProps, useAdminNav() (+4 more)
...
Cohesion: 0.07
Nodes (29): @/components/UnsplashAttribution.astro, @/components/Footer.astro, @/components/Header.astro, safeProfileUrl, UnsplashAttribution(), UnsplashAttributionProps, redirectNewWindowCache, SITE_REDIRECT_HOSTS (+21 more)
...
Cohesion: 0.11
Nodes (19): columns, name, admin_user_account_template_choice_admin_user_id_social_media_account_id_pk, columns, concurrently, isUnique, method, name (+11 more)
...
Cohesion: 0.18
Nodes (17): ActiveZoom, attachHlsPlayer(), clearFrameInlineStyles(), closeVideoZoom(), createCloseButton(), finishZoomClose(), getVideoZoomFrameForShortcut(), getZoomTargetRect() (+9 more)
...
Cohesion: 0.11
Nodes (18): form_submissions_form_config_id_form_configs_id_fk, columnsFrom, columnsTo, name, onDelete, onUpdate, tableFrom, tableTo (+10 more)
...
Cohesion: 0.12
Nodes (9): DACH_BOUNDS, DACH_CENTER, getDefaultPrefs(), LAYERS, loadPrefs(), MapPrefs, markerIcon, savePrefs() (+1 more)

### Community 656 - "Community 656"
Cohesion: 0.15
Nodes (13): api, fetchWithTimeout(), handleResponse(), UploadProgress, UploadRequestOptions, ApiRequestError, createApiRequestError(), createNetworkRequestError() (+5 more)

### Community 657 - "Community 657"
Cohesion: 0.12
Nodes (17): shop_categories_category_id_categories_id_fk, shop_categories_shop_id_shops_id_fk, foreignKeys, columnsFrom, columnsTo, name, onDelete, onUpdate (+9 more)
...
Cohesion: 0.17
Nodes (12): applySuggestionsStatusFilterSearchParam(), parseSuggestionsStatusFilter(), readStoredSuggestionsStatusFilter(), SUGGESTIONS_STATUS_FILTERS, SuggestionsStatusFilter, writeStoredSuggestionsStatusFilter(), DEFAULT_SUGGESTIONS_SORT, ReportTabParam (+4 more)
...
Cohesion: 0.12
Nodes (20): cn(), MultiSelect(), MultiSelectOption, MultiSelectProps, multiSelectVariants, CARD_NETWORKS, getSelectablePaymentMethods(), getPaymentMethodLabel() (+12 more)
...
Cohesion: 0.12
Nodes (15): compilerOptions, esModuleInterop, forceConsistentCasingInFileNames, isolatedModules, jsx, module, moduleResolution, outDir (+7 more)

### Community 820 - "Community 820"
Cohesion: 0.12
Nodes (15): dependencies, @lmaa/shared, zod, devDependencies, typescript, exports, name, private (+7 more)
...
Cohesion: 0.16
Nodes (28): applyThemeClass(), bindCustomSelect(), bindCustomSelectDocumentEvents(), bindThemeSwitches(), closeCustomSelect(), closeOtherCustomSelects(), effectiveTheme(), escapeHtml() (+20 more)
...
Cohesion: 0.11
Nodes (18): SocialMediaOrderEditor(), SOCIAL_MEDIA_ACCOUNTS_KEY, useCreateSocialMediaAccount(), useDeleteSocialMediaAccount(), useFooterEligibleAccounts(), useSocialMediaAccounts(), useUpdateSocialMediaAccount(), AccountFormDialog() (+10 more)
...
Cohesion: 0.16
Nodes (10): API_BASE, apiGetInternal(), getJson(), normalizeApiBase(), requestHeaders(), resolveApiBase(), responseCache, cacheableSeconds() (+2 more)

### Community 830 - "Community 830"
Cohesion: 0.09
Nodes (20): ImportResult, useAdminSubmission(), useDeleteSubmission(), useEditSubmission(), useImportSubmissions(), useReviewSubmission(), LoadedSubmissionEditorPage(), ResolvedSubmissionEditorPage() (+12 more)
...
Cohesion: 0.13
Nodes (14): name, notNull, primaryKey, type, category_id, dialect, id, prevId (+6 more)
...
Cohesion: 0.17
Nodes (11): contentPreviewMocks, footerMocks, footerPreviewMocks, formConfigMocks, formSubmissionMocks, formValidationMocks, heroMocks, markdownMocks (+3 more)

### Community 859 - "Community 859"
Cohesion: 0.19
Nodes (14): FieldControlSize, FieldShell(), FieldShellControlProps, FieldShellProps, hasExplicitWidthClass(), hasInvalidState(), InputPrimitive(), InputPrimitiveProps (+6 more)
...
Cohesion: 0.14
Nodes (14): id, nav_id, page_slug, name, notNull, primaryKey, type, name (+6 more)
...
Cohesion: 0.16
Nodes (9): createEmptyWidget(), createWidgetKey(), EMPTY_CSP, getAutoOrigins(), getOriginsFromText(), joinOrigins(), CspField, WidgetEditorPanel() (+1 more)

### Community 884 - "Community 884"
Cohesion: 0.14
Nodes (14): dependencies, class-variance-authority, @codemirror/lang-json, @codemirror/lang-markdown, @codemirror/language, @codemirror/state, @codemirror/view, leaflet (+6 more)
...
Cohesion: 0.12
Nodes (16): FormBuilderEditPage(), FormBuilderListPage(), ImportFormData, NewFormDialog(), CreateFormConfigInput, ImportFormConfigInput, useCreateFormConfig(), useDeleteFormConfig() (+8 more)
...
Cohesion: 0.11
Nodes (10): obfuscateFirstPartyChunks(), OBFUSCATOR_OPTIONS, buildForwardedForHeader(), withFrameAncestors(), BACKEND_ORIGIN, forwardClientAddress(), isLoopbackHost(), normalizeApiBase() (+2 more)
...
Cohesion: 0.15
Nodes (10): ColorLabelKey, COLORS, SearchAction, SearchState, UnsplashBrowser(), UnsplashBrowserProps, UnsplashColorValue, UnsplashPhoto (+2 more)
...
Cohesion: 0.14
Nodes (6): editorTheme, EMPTY_EXTENSIONS, highlightStyle, lmaaTheme, MarkdownEditorProps, mdKeymap

### Community 896 - "Community 896"
Cohesion: 0.36
Nodes (10): admin_users, categories, content_pages, dead_link_reports, sessions, shop_categories, shop_concern_reports, shops (+2 more)

### Community 897 - "Community 897"
Cohesion: 0.18
Nodes (10): compilerOptions, baseUrl, jsx, jsxImportSource, paths, exclude, extends, @/* (+2 more)
...
Cohesion: 0.27
Nodes (9): cx(), isSeparatorItem(), SubMenu, SubMenuActionItemProps, SubMenuItem(), SubMenuItemProps, SubMenuRoot(), SubMenuRootProps (+1 more)

### Community 903 - "Community 903"
Cohesion: 0.25
Nodes (8): AdminRole, AdminInviteState, AdminLocale, AdminLogin, AdminSetup, AdminStats, AdminUser, AdminUserInvite
...
Cohesion: 0.08
Nodes (37): shopCategories, ImageUploadFailure, ImageUploadSuccess, processImageUpload(), detectImageType(), AdminCategorySummary, categoryExists(), clearAdminCategoryImage() (+29 more)
...
Cohesion: 0.29
Nodes (4): exportEmailTemplateSingle(), exportFormConfigAll(), exportFormConfigSingle(), downloadJson()
...
Cohesion: 0.29
Nodes (6): DomainAlertRule, domainAlertRuleSchema, DomainAlertRulesConfig, domainAlertRulesConfigSchema, normalizeDomainAlertDomain(), parseDomainAlertDomains()
...
Cohesion: 0.29
Nodes (4): DropdownOption, DropdownProps, hasPositiveCount(), toComboboxOption()

### Community 918 - "Community 918"
Cohesion: 0.25
Nodes (7): name, peerDependencies, react, react-dom, private, type, version

### Community 919 - "Community 919"
Cohesion: 0.43
Nodes (7): cx(), PageBody(), PageLayout(), PageSplitAside(), PageSplitLayout(), PageSplitLayoutProps, PageSplitMain()
...
Cohesion: 0.29
Nodes (5): KeyboardSaveContext, KeyboardSaveContextValue, KeyboardSaveRegistration, useKeyboardSave(), SaveActionButton()
...
Cohesion: 0.15
Nodes (12): INTERACTIVE_ONLY_SECTION_PATTERNS, INTERACTIVE_ONLY_SECTIONS, isReviewSkillAvailable(), loadReviewSkill(), SKILL_SEARCH_ROOTS, toAutomationRules(), acceptPayload, companySize (+4 more)
...
Cohesion: 0.06
Nodes (23): BodyCardContext, BodyCardContextValue, useBodyCard(), PageFooterContext, PageFooterContextValue, usePageFooterContext(), PageHeaderContext, PageHeaderContextValue (+15 more)
...
Cohesion: 0.09
Nodes (22): scripts, build, build:backend, build:dashboard, build:frontend, ci:quality, ci:smoke, db:doctor (+14 more)
...
Cohesion: 0.09
Nodes (17): loginSchema, setupSchema, categoryBodySchema, categoryCreateSchema, categoryUpdateSchema, TemplateAssignment, templateAssignmentSchema, MarkdownWidget (+9 more)
...
Cohesion: 0.03
Nodes (86): Ne(), AdminUser, AdminUserAccountTemplateChoiceInsert, AdminUserInsert, adminUsers, AppSetting, appSettings, BackgroundError (+78 more)
...
Cohesion: 0.06
Nodes (38): COUNTRY_DISPLAY_NAMES, CountryCodeOption, EUROPEAN_COUNTRY_CODES, CountryCodeSelect(), CountryCodeSelectProps, FormField(), FormFieldProps, FormErrorText() (+30 more)
...
Cohesion: 0.29
Nodes (6): mediaFolderColorSchema, MediaFolderCreateInput, mediaFolderCreateSchema, MediaFolderUpdateInput, mediaFolderUpdateSchema, mediaUpdateSchema

### Community 972 - "Community 972"
Cohesion: 0.08
Nodes (26): checkboxBoxSizeClass, checkboxIconSizeClass, CheckboxPrimitive(), CheckboxPrimitiveProps, CheckboxPrimitiveSize, SwitchPrimitive(), SwitchPrimitiveProps, SwitchPrimitiveSize (+18 more)

### Community 973 - "Community 973"
Cohesion: 0.15
Nodes (12): entryPoints, entryPointStrategy, excludeInternal, excludePrivate, excludeProtected, hideGenerator, out, readme (+4 more)
...
Cohesion: 0.12
Nodes (17): scripts, build, db:doctor, db:migrate, dev, docs:build, email:preview, format (+9 more)
...
Cohesion: 0.20
Nodes (10): devDependencies, drizzle-kit, drizzle-orm, eslint, eslint-plugin-import, prettier, react-doctor, typedoc (+2 more)
...
Cohesion: 0.17
Nodes (11): dependencies, react-icons, engines, node, npm, name, overrides, marked (+3 more)
...
Cohesion: 0.09
Nodes (19): TemplateAssignmentsSection(), TemplateAssignmentsSectionProps, usePostingAccount(), SOCIAL_MEDIA_POST_TEMPLATES_KEY, useCreateSocialMediaPostTemplate(), useDeleteSocialMediaPostTemplate(), useSocialMediaPostTemplate(), useSocialMediaPostTemplates() (+11 more)
...
Cohesion: 0.38
Nodes (5): navColumnReducer(), NavColumnState, NavItemState, NO_NAV_ITEMS, base
...
Cohesion: 0.15
Nodes (13): devDependencies, drizzle-kit, periwinkle, pino-pretty, react, react-email, tsup, tsx (+5 more)
...
Cohesion: 0.13
Nodes (19): REVIEW_AUTO_APPLY_VERDICTS, REVIEW_AUTOMATION_MODES, REVIEW_JOB_STATES, REVIEW_JOB_TRANSITIONS, REVIEW_REPORT_STATES, REVIEW_VERDICTS, ReviewAutoApplyVerdict, ReviewAutomationMode (+11 more)

### Community 1010 - "Community 1010"
Cohesion: 0.18
Nodes (10): REVIEW_EFFORT_LEVELS, REVIEW_SETTING_DEFAULTS, ReviewEffortLevel, SETTINGS_KEYS, SettingsKey, SYSTEM_NOTIFICATION_SETTINGS_KEYS, SYSTEM_REDIRECT_SETTINGS_KEYS, SYSTEM_REVIEW_SETTINGS_KEYS (+2 more)

### Community 1011 - "Community 1011"
Cohesion: 0.08
Nodes (19): acceptGeoSchema, acceptHeadquartersSchema, companySizeSchema, criterionRatingSchema, publicUrl, ratingEnum, regionCodeSchema, REVIEW_SOCIAL_PLATFORMS (+11 more)
...
Cohesion: 0.13
Nodes (24): MarkdownShortcodeDefinition, MarkdownShortcodeParamDefinition, findAttribute(), MarkdownShortcodeAttribute, MarkdownShortcodeAttributeValue, MarkdownShortcodeIssue, MarkdownShortcodeIssueCode, MarkdownShortcodeParamValue (+16 more)

### Community 1026 - "Community 1026"
Cohesion: 0.29
Nodes (7): optionalDependencies, @img/sharp-libvips-linux-x64, @img/sharp-libvips-linuxmusl-x64, @img/sharp-linux-x64, @img/sharp-linuxmusl-x64, @rollup/rollup-linux-x64-gnu, @rollup/rollup-linux-x64-musl
...
Cohesion: 0.05
Nodes (58): AdminUserAccountTemplateChoice, Category, SocialMediaAccount, SocialMediaPostTemplate, SocialMediaPostTemplateInsert, socialMediaPostTemplates, Submission, listChoicesForAdminUser() (+50 more)
...
Cohesion: 0.40
Nodes (4): "shop_geo_cities", "shop_geo_countries", "shop_geo_regions", "shop_headquarters"

### Community 1037 - "Community 1037"
Cohesion: 0.40
Nodes (4): "affiliate_scan_jobs", "affiliate_scans", "shops", "submissions"

### Community 1038 - "Community 1038"
Cohesion: 0.40
Nodes (3): MastodonAccountFormInput, MastodonAccountFormProps, VISIBILITY_OPTIONS
...
Cohesion: 0.67
Nodes (3): cx(), HlsAssetVisual(), HlsAssetVisualProps
...
Cohesion: 0.40
Nodes (3): MediaUploadOverlayProps, MediaUploadPhase, MediaUploadProgress
...
Cohesion: 0.29
Nodes (4): answers, created, FakeAnthropic, request
...
Cohesion: 0.13
Nodes (9): DomainAlertDialogTarget, DomainAlertRuleDialog(), DomainAlertRuleDialogProps, DomainAlertRuleDialogState, DomainAlertsAction, DomainAlertsState, DomainAlertsTabProps, getRuleErrors() (+1 more)
...
Cohesion: 0.15
Nodes (7): DashboardSection(), DashboardSectionContext, DashboardSectionContextValue, DashboardSectionFooterProps, DashboardSectionHeaderProps, DashboardSectionItemProps, DashboardSectionProps

### Community 1093 - "Community 1093"
Cohesion: 0.33
Nodes (6): buildEpcQrPayload(), EpcQrDetails, EpcQrError, formatAmount(), normalizeIban(), PAYEE
...
Cohesion: 0.29
Nodes (6): editorTheme, EMPTY_EXTENSIONS, highlightStyle, JsonEditor(), JsonEditorProps, jsonTheme
...
Cohesion: 0.20
Nodes (8): ReviewModelOption, SETTINGS_KEY, useReviewModels(), useSaveSystemSetting(), useSystemSettings(), NotificationDraftState, EDITED_KEYS, ReviewDraft

### Community 1118 - "Community 1118"
Cohesion: 0.18
Nodes (9): getRedirectErrors(), publicRedirectUrl(), RedirectUrlDialog(), RedirectUrlDialogProps, RedirectUrlDialogState, RedirectUrlDialogTarget, RedirectUrlsAction, RedirectUrlsPage (+1 more)

### Community 1119 - "Community 1119"
Cohesion: 0.22
Nodes (7): handleMediaDrop(), HandleMediaDropOptions, hasDraggedFiles(), collectDroppedHlsBundles(), handleMediaDragOver(), useMediaDropZone(), UseMediaDropZoneOptions
...
Cohesion: 0.22
Nodes (6): MediaUploadBatchProgress, MediaUploadOptions, MediaUploadWorkflowResult, UploadConflictApplyAllResolution, UploadConflictResolution, UseMediaUploadWorkflowOptions

### Community 1141 - "Community 1141"
Cohesion: 0.22
Nodes (7): normalizeRedirectUrlName(), RedirectUrlEntry, redirectUrlEntrySchema, RedirectUrlsConfig, redirectUrlsConfigSchema, createEmptyRedirect(), createId()

### Community 1142 - "Community 1142"
Cohesion: 0.18
Nodes (8): clampToViewport(), describeType(), HelpFrame, MarkdownShortcodeReference(), ParamRow(), readFrame(), RESIZE_EDGES, ResizeEdge
...
Cohesion: 0.29
Nodes (5): MEDIA_FOLDER_COLOR_OPTIONS, MEDIA_FOLDER_COLOR_VALUES, resolveMediaFolderColor(), MediaFolderGridItem(), MediaFolderGridItemProps
...
Cohesion: 0.29
Nodes (5): MediaPageHeader(), MediaPageHeaderProps, useMediaFilePicker(), UseMediaFilePickerOptions, UseMediaFilePickerResult

### Community 1152 - "Community 1152"
Cohesion: 0.29
Nodes (6): MediaSelectionStateUpdate, SelectionAnchor, SelectionBox, SelectionKind, useMediaSelection(), UseMediaSelectionOptions
...
Cohesion: 0.40
Nodes (5): name, notNull, primaryKey, type, application_url

### Community 1155 - "Community 1155"
Cohesion: 0.08
Nodes (14): Theme, ThemeContext, ThemeContextValue, useTheme(), EmailPreview(), EmailPreviewProps, ThemeToggle(), getSegmentedStorageKey() (+6 more)
...
Cohesion: 0.33
Nodes (5): INITIAL_STATE, MediaContextMenuState, useMediaContextMenu(), UseMediaContextMenuOptions, UseMediaContextMenuResult
...
Cohesion: 0.22
Nodes (5): formatMediaDate(), MediaFolderSidebar(), MediaFolderSidebarProps, MediaInfoSection(), MediaInfoSectionProps

### Community 1171 - "Community 1171"
Cohesion: 0.33
Nodes (6): validation, invalidLink, invalidPath, notDocumented, notExported, rewrittenLink

### Community 1172 - "Community 1172"
Cohesion: 0.25
Nodes (7): ContentPage, ContentPageSummary, ContentStatus, ContentWidth, NavId, NavItem, NavTarget
...
Cohesion: 0.29
Nodes (11): getImageBrightness(), getImageContrast(), getImageFilter(), getImageOffsetX(), getImageOffsetY(), getImageTintColor(), getImageTintOpacity(), getImageTintStyle() (+3 more)
...
Cohesion: 0.40
Nodes (4): useDismissShopConcern(), useShopConcernReports(), RejectTarget, ShopReportsTab()
...
Cohesion: 0.33
Nodes (5): cx(), frameClassByVariant, iconSizeByVariant, MediaAssetPreviewProps, MediaAssetPreviewVariant

### Community 1193 - "Community 1193"
Cohesion: 0.47
Nodes (5): hasImageClipboardSupport(), hasShowSaveFilePicker(), MediaContextMenu(), MediaContextMenuProps, MediaContextMenuVariant
...
Cohesion: 0.29
Nodes (5): backgroundErrorMocks, mailMocks, pushMocks, rendererMocks, repoMocks
...
Cohesion: 0.20
Nodes (5): companySize, criteria, evidence, moderation, submissionRepository
...
Cohesion: 0.29
Nodes (6): EmailTemplate, emailTemplateCreateSchema, emailTemplateImportSchema, EmailTemplateInput, emailTemplatePreviewSchema, emailTemplateUpdateSchema
...
Cohesion: 0.40
Nodes (5): devDependencies, @types/leaflet, @types/react, @types/react-dom, typescript

### Community 1273 - "Community 1273"
Cohesion: 0.40
Nodes (5): scripts, format, format:check, lint, typecheck

### Community 1274 - "Community 1274"
Cohesion: 0.40
Nodes (3): SegmentSwitchOption, SegmentSwitchProps, sizeMap

### Community 1275 - "Community 1275"
Cohesion: 0.40
Nodes (3): ALL_OPTIONS, ThemeOption, ThemeSegmentedControlProps
...
Cohesion: 0.67
Nodes (3): buildPreviewVariables(), CategoryPostPreviewContext, renderCategoryPostPreview()

### Community 1278 - "Community 1278"
Cohesion: 0.50
Nodes (3): "categories", "hero_images", "unsplash_images"

### Community 1280 - "Community 1280"
Cohesion: 0.83
Nodes (3): optionalText(), parseCoordinate(), toHeadquartersPayload()
...
Cohesion: 0.03
Nodes (122): reviewJobRoutes, resolveEffortLevel(), client, ReviewEventRow, reviewEvents, ReviewJobRow, reviewJobs, reviewSpend (+114 more)
...
Cohesion: 0.40
Nodes (4): CreateFolderInput, MoveAssetInput, UpdateFolderInput, useMediaFolderMutations()
...
Cohesion: 0.40
Nodes (4): callLog, migratorMocks, postgresMocks, safetyMocks
...
Cohesion: 0.40
Nodes (4): DomainAlertsTab, NotificationsTab, ReviewTab, SystemSettingsPage()
...
Cohesion: 0.50
Nodes (3): stripFileExtension(), MediaGridItem(), MediaGridItemProps
...
## Knowledge Gaps
- **22576 isolated node(s):** `printWidth`, `tabWidth`, `useTabs`, `semi`, `singleQuote` (+22571 more)
...
- **Why does `useI18n()` connect `Community 4` to `Community 1155`, `Community 520`, `Community 9`, `Community 10`, `Community 1178`, `Community 1181`, `Community 32`, `Community 1186`, `Community 932`, `Community 424`, `Community 425`, `Community 1579`, `Community 49`, `Community 827`, `Community 1085`, `Community 830`, `Community 192`, `Community 839`, `Community 203`, `Community 988`, `Community 1118`, `Community 1631`, `Community 738`, `Community 483`, `Community 484`, `Community 233`, `Community 235`, `Community 110`, `Community 113`, `Community 883`, `Community 1014`, `Community 888`, `Community 505`, `Community 1147`, `Community 1148`, `Community 893`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `UnsplashBrowser()` connect `Community 893` to `Community 4`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Why does `indexes` connect `Community 717` to `Community 716`?**
  _High betweenness centrality (0.000) - this node is a cross-community bridge._
- **Are the 97 inferred relationships involving `useI18n()` (e.g. with `ContentEditorLoadingFallback()` and `InvitePage()`) actually correct?**
  _`useI18n()` has 97 INFERRED edges - model-reasoned connections that need verification._
- **What connects `printWidth`, `tabWidth`, `useTabs` to the rest of the system?**
  _22576 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.03252468870759983 - nodes in this community are weakly interconnected._
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.03502919099249374 - nodes in this community are weakly interconnected._