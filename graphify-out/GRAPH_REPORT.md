# Graph Report - WebApp  (2026-07-14)

## Corpus Check
- 760 files · ~526,907 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27344 nodes · 31274 edges · 1451 communities (1352 shown, 99 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 374 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `055d93e1`
...
## Communities (1451 total, 99 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (118): shopLikes, geocode(), GeocodingResult, extractEuropeanPostalCodePrefix(), normalizePostalQuery(), POSTAL_PATTERNS, PostalPattern, parseCountryFilter() (+110 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (123): AdminUser, AdminUserAccountTemplateChoice, AdminUserAccountTemplateChoiceInsert, AdminUserInsert, AppSetting, BackgroundError, backgroundErrors, Category (+115 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (77): emailTemplateRoutes, EmailTemplate, EmailTemplateInsert, shopCategories, submissionCategories, submissions, isEmailRecipient(), ESCAPE_MAP (+69 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (64): backgroundErrorsRoutes, deadLinkReportsRoutes, folderRoutes, footerConfigRoutes, markdownWidgetsRoutes, meTemplateChoicesRoutes, querySchema, hlsBundleCompleteSchema (+56 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (69): EventListCard(), EventListCardProps, AnalyticsPage(), AnalyticsSection, CollapsibleList(), CollapsibleListProps, ContentEditorLoadingFallback(), CategoriesPage() (+61 more)
...
Cohesion: 0.10
Nodes (14): CategoryEditAction, CategoryEditCard(), CategoryEditCardProps, CategoryEditLabels, CategoryEditState, CategoryFormPanelProps, CategoryImagePanelProps, CategoryUnsplashPhoto (+6 more)
...
Cohesion: 0.07
Nodes (36): COUNTRY_DISPLAY_NAMES, CountryCodeOption, EUROPEAN_COUNTRY_CODES, CountryCodeSelect(), CountryCodeSelectProps, FormField(), FormFieldProps, FormErrorText() (+28 more)
...
Cohesion: 0.02
Nodes (64): UiPreferences, useUpdateUiPreferences(), CategoryGridItem(), CategoryGridItemProps, bgColor, letter, useDeleteShopReminder(), useSetShopReminder() (+56 more)
...
Cohesion: 0.05
Nodes (36): AuthContext, authMeQueryKey, authSetupQueryKey, AuthState, useAuth(), FormState, InvitePage(), FIELD_IDS (+28 more)
...
Cohesion: 0.04
Nodes (89): mediaAssets, mediaFolders, buildCopySource(), buildS3Metadata(), completeStagedHlsBundle(), DOCUMENT_MIME_BY_EXTENSION, getMediaPublicUrl(), HLS_MIME_BY_EXTENSION (+81 more)
...
Cohesion: 0.18
Nodes (9): AlertDialog(), AlertDialogProps, AlertVariant, variantIcons, ButtonPrimitive(), Dialog(), DialogFooterProps, DialogProps (+1 more)
...
Cohesion: 0.05
Nodes (32): SETTINGS_KEY, useSaveSystemSetting(), useSystemSettings(), DomainAlertDialogTarget, DomainAlertRuleDialog(), DomainAlertRuleDialogProps, DomainAlertRuleDialogState, DomainAlertsAction (+24 more)
...
Cohesion: 0.06
Nodes (35): usePersistedTextareaHeight(), ImportResult, useAdminSubmission(), useDeleteSubmission(), useEditSubmission(), useImportSubmissions(), useReviewSubmission(), getSegmentedStorageKey() (+27 more)
...
Cohesion: 0.09
Nodes (22): ButtonPrimitiveProps, ButtonPrimitiveSize, ButtonPrimitiveVariant, buttonSizeClass, buttonVariantClass, IconButtonPrimitive(), IconButtonPrimitiveAccessibleName, IconButtonPrimitiveProps (+14 more)
...
Cohesion: 0.03
Nodes (84): adminRoutes, env, envSchema, client, db, AppliedMigrationRow, ExistingColumnRow, ExistingObjectRow (+76 more)
...
Cohesion: 0.13
Nodes (14): dependencies, react-icons, name, optionalDependencies, @img/sharp-libvips-linux-x64, @img/sharp-libvips-linuxmusl-x64, @img/sharp-linux-x64, @img/sharp-linuxmusl-x64 (+6 more)
...
## Knowledge Gaps
- **19644 isolated node(s):** `auto-migrate.sh script`, `version`, `configurations`, `PreToolUse`, `allow` (+19639 more)
...
- **Why does `useI18n()` connect `Community 4` to `Community 520`, `Community 9`, `Community 10`, `Community 31`, `Community 927`, `Community 928`, `Community 290`, `Community 930`, `Community 38`, `Community 424`, `Community 425`, `Community 299`, `Community 942`, `Community 49`, `Community 818`, `Community 822`, `Community 191`, `Community 839`, `Community 203`, `Community 483`, `Community 484`, `Community 233`, `Community 235`, `Community 883`, `Community 117`, `Community 505`, `Community 893`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 424` to `Community 290`, `Community 4`, `Community 38`, `Community 9`, `Community 822`, `Community 31`, `Community 191`?**
...
- **What connects `auto-migrate.sh script`, `version`, `configurations` to the rest of the system?**
  _19644 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.033276084156290256 - nodes in this community are weakly interconnected._
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.021948122619263558 - nodes in this community are weakly interconnected._