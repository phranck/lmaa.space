...
## Corpus Check
- 818 files · ~623,077 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 30414 nodes · 34911 edges · 1595 communities (1496 shown, 99 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 397 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4f1d2965`
...
## Communities (1595 total, 99 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.06
Nodes (55): cache, CacheEntry, getCacheEntry(), getCacheStats(), setCacheEntry(), startCacheCleanupJob(), countPendingSubmissions(), countPublicShops() (+47 more)
...
Cohesion: 0.04
Nodes (93): emailTemplateRoutes, env, envSchema, EmailTemplateInsert, extractRecipientAddress(), isEmailRecipient(), ESCAPE_MAP, escapeHtml() (+85 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (58): backgroundErrorsRoutes, deadLinkReportsRoutes, folderRoutes, footerConfigRoutes, formConfigRoutes, markdownWidgetsRoutes, meTemplateChoicesRoutes, querySchema (+50 more)
...
Cohesion: 0.05
Nodes (69): authRoutes, inviteAcceptLimit, inviteLookupLimit, uiPreferencesSchema, usersRoutes, adminUsers, failure, Result (+61 more)
...
Cohesion: 0.08
Nodes (36): AddressParts, describePhotonFeature(), geocode(), geocodeAddress(), GeocodingResult, NominatimEntry, PhotonResponse, queryNominatim() (+28 more)
...
Cohesion: 0.04
Nodes (48): name, notNull, primaryKey, type, application_url, commission, compensation_model, program_found (+40 more)
...
Cohesion: 0.14
Nodes (26): contentRoutes, CONTENT_PAGE_SUMMARY_FIELDS, ContentPageDetailRow, contentPageSlugExists(), ContentPageStatus, ContentPageSummaryRow, ContentPageWidth, createContentPage() (+18 more)

### Community 141 - "Community 141"
Cohesion: 0.09
Nodes (17): dateFormatter, FormSubmitEvent, PAGE_SIZE_OPTIONS, RejectedShopsTableDataAction, RejectedShopsTableDataState, RejectedShopsTableProps, RejectedShopsTableState, SORT_COLUMN_WIDTHS (+9 more)
...
Cohesion: 0.06
Nodes (27): adminRoutes, rateLimitEntries, sessions, DatabaseRateLimitStore, MemoryRateLimitStore, rateLimit(), RateLimitEntry, RateLimitStore (+19 more)
...
Cohesion: 0.09
Nodes (27): deadLinkReports, shopLikes, categoryNameMatch(), countPublicRejectedShops(), findPendingSubmissionByDomain(), findRejectedSubmissionByDomain(), findShopByDomain(), listPublicRejectedShops() (+19 more)

### Community 233 - "Community 233"
Cohesion: 0.09
Nodes (12): DashboardActionAriaBehavior, DashboardActionButton(), DashboardActionColorRole, DashboardActionIcon, DashboardActionId, DashboardActionLabelKey, DashboardActionStatus, getActionLabelKey() (+4 more)
...
Cohesion: 0.05
Nodes (65): readBodyWithLimit(), readJsonWithLimit(), readTextWithLimit(), Candidate, CandidateKind, collectInlineImages(), collectJsonLdBlocks(), collectJsonLdImages() (+57 more)
...
Cohesion: 0.06
Nodes (39): outputPath, apiReferenceContentSecurityPolicy, buildCodeSamples(), buildOpenApiDocument(), buildPaths(), buildPublicSchemas(), collectComponentSchemaRefs(), documentedRouteKeys() (+31 more)
...
Cohesion: 0.07
Nodes (21): likedShops, saveLikedShopsAndUpdateNav(), updateMyShopsNavVisibility(), isShopLiked(), ShopCardProps, ShopCardReact(), ShopCategory, LikedShopsAction (+13 more)
...
Cohesion: 0.13
Nodes (10): NAV_TEXT, NavColumnAddSectionProps, NavColumnHandle, NavColumnProps, NavItemState, NavManagerPage(), NavText, Phase (+2 more)
...
Cohesion: 0.20
Nodes (20): parseCountryFilter(), parseRegionFilter(), ShopFilterParams, shopFilterSchema, CategoryShopRow, buildConditions(), categoryNameMatch(), countFilteredPublicShops() (+12 more)
...
Cohesion: 0.18
Nodes (6): ErrorBoundary, Props, State, resolveInitialLocale(), queryClient, rootEl
...
Cohesion: 0.05
Nodes (55): Category, SocialMediaAccount, SocialMediaPostTemplate, SocialMediaPostTemplateInsert, socialMediaPostTemplates, Submission, upsertChoice(), getAccountById() (+47 more)
...
Cohesion: 0.05
Nodes (69): categoriesRoutes, focalPointSchema, unsplashImageSchema, updateCategoryHandler, addHeroImageSchema, focalPointSchema, heroRoutes, rotationIntervalSchema (+61 more)
...
Cohesion: 0.02
Nodes (129): Ne(), db, AdminUser, AdminUserAccountTemplateChoice, AdminUserAccountTemplateChoiceInsert, AdminUserInsert, AppSetting, appSettings (+121 more)
...
Cohesion: 0.03
Nodes (54): bgColor, letter, useDeleteShopReminder(), useSetShopReminder(), useShopReminder(), DASHBOARD_MESSAGES, DashboardLocale, DashboardMessages (+46 more)
...
Cohesion: 0.17
Nodes (10): intTicks(), RealtimeBarsChart, RealtimeCard(), useTheme(), EmailPreview(), EmailPreviewProps, useUmamiActive(), useUmamiRealtime() (+2 more)
...
Cohesion: 0.29
Nodes (3): Theme, ThemeContext, ThemeContextValue
...
Cohesion: 0.48
Nodes (6): EMPTY_DOMAIN_ALERT_RULES_CONFIG, findMatchingDomainAlertRule(), getManagedDomainAlertRulesConfig(), getUrlHostname(), matchesDomainAlertRule(), normalizeHostname()
...
Cohesion: 0.47
Nodes (4): extractEuropeanPostalCodePrefix(), normalizePostalQuery(), POSTAL_PATTERNS, PostalPattern
...
Cohesion: 0.04
Nodes (94): reviewJobRoutes, resolveEffortLevel(), client, ReviewEventRow, reviewEvents, ReviewJobRow, reviewJobs, reviewSpend (+86 more)
...
## Knowledge Gaps
- **21867 isolated node(s):** `printWidth`, `tabWidth`, `useTabs`, `semi`, `singleQuote` (+21862 more)
...
- **What connects `printWidth`, `tabWidth`, `useTabs` to the rest of the system?**
  _21867 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.03824424163407214 - nodes in this community are weakly interconnected._