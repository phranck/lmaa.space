...
## Corpus Check
- 757 files · ~535,884 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27785 nodes · 31805 edges · 1474 communities (1383 shown, 91 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 384 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8cf5fd52`
...
## Communities (1474 total, 91 thin omitted)
...
Cohesion: 0.03
Nodes (99): AdminUser, AdminUserAccountTemplateChoice, AdminUserAccountTemplateChoiceInsert, AdminUserInsert, AppSetting, appSettings, Category, CategoryInsert (+91 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (59): emailTemplateRoutes, EmailTemplateInsert, formSubmissions, isEmailRecipient(), ESCAPE_MAP, escapeHtml(), createSubmissionFromFormData(), getSettings() (+51 more)
...
Cohesion: 0.06
Nodes (63): authRoutes, uiPreferencesSchema, usersRoutes, adminUsers, acceptInviteWithSession(), CreateOwnerAdminInput, createOwnerAdminWithSession(), createSession() (+55 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (41): createHlsUploadBatches(), HLS_UPLOAD_CHUNK_TARGET_BYTES, HlsBundleCompletePayload, MediaBundleUpload, MediaBundleUploadFile, MediaFileUpload, uploadChunkedHlsBundle(), useDeleteMediaAssets() (+33 more)

### Community 10 - "Community 10"
Cohesion: 0.06
Nodes (58): getAdminShopQueryFn(), getAdminShopQueryKey(), ShopReviewImportResult, ShopVisibilityCounts, useAcceptShopReview(), useAdminShop(), useDeleteShop(), useDeleteShopReminder() (+50 more)
...
Cohesion: 0.04
Nodes (84): shopsRoutes, updateShopHandler, mapShopJsonToSubmissionEditData(), Shop, shopCategories, shopGeoCities, shopGeoCountries, shopGeoRegions (+76 more)
...
Cohesion: 0.04
Nodes (41): formatDuration(), intTicks(), previousValueFromChange(), relativeChange(), AnalyticsSection(), TrafficAreaChart, MetricList(), MetricListProps (+33 more)
...
Cohesion: 0.10
Nodes (33): addHeroImageSchema, focalPointSchema, heroRoutes, rotationIntervalSchema, rotationSchema, toggleSelectedSchema, HeroImage, heroImages (+25 more)
...
Cohesion: 0.08
Nodes (25): dateFormatter, FormSubmitEvent, PAGE_SIZE_OPTIONS, RejectedShopsTableDataAction, RejectedShopsTableDataState, RejectedShopsTableProps, RejectedShopsTableState, SORT_COLUMN_WIDTHS (+17 more)
...
Cohesion: 0.03
Nodes (82): adminRoutes, env, envSchema, client, db, AppliedMigrationRow, ExistingColumnRow, ExistingObjectRow (+74 more)
...
Cohesion: 0.09
Nodes (21): useAdminContentPage(), useContentPages(), useCreateContentPage(), useCreateContentPreviewSession(), useDeleteContentPage(), usePatchContentPage(), useSaveContentPage(), useAdminNav() (+13 more)
...
Cohesion: 0.10
Nodes (26): cx(), FieldControlSize, FieldShell(), FieldShellControlProps, FieldShellProps, hasExplicitWidthClass(), hasInvalidState(), InputPrimitive() (+18 more)
...
Cohesion: 0.07
Nodes (27): UiPreferences, useUpdateUiPreferences(), useAdminShops(), useImportShopReviewResults(), useShopVisibilityCounts(), useDeadLinkReports(), useDeleteShopFromDeadLinks(), useDismissDeadLink() (+19 more)
...
Cohesion: 0.08
Nodes (37): categoriesRoutes, focalPointSchema, unsplashImageSchema, updateCategoryHandler, ImageUploadFailure, ImageUploadSuccess, processImageUpload(), failure (+29 more)
...
Cohesion: 0.05
Nodes (24): BodyCardContext, BodyCardContextValue, useBodyCard(), PageFooterContext, PageFooterContextValue, usePageFooterContext(), PageHeaderContext, PageHeaderContextValue (+16 more)
...
Cohesion: 0.04
Nodes (38): bgColor, letter, DASHBOARD_MESSAGES, DashboardLocale, DashboardMessages, mediaFolderHref(), mediaFolderPath(), MediaDeleteDialogProps (+30 more)
...
Cohesion: 0.67
Nodes (3): downloadFilenameForAsset(), extensionForMimeType(), MIME_EXTENSION_MAP
...
Cohesion: 0.67
Nodes (3): buildPreviewVariables(), PostPreviewContext, renderPostPreview()
...
- **Why does `useI18n()` connect `Community 4` to `Community 9`, `Community 10`, `Community 912`, `Community 923`, `Community 31`, `Community 289`, `Community 290`, `Community 932`, `Community 424`, `Community 425`, `Community 1449`, `Community 49`, `Community 822`, `Community 955`, `Community 828`, `Community 957`, `Community 966`, `Community 839`, `Community 203`, `Community 483`, `Community 484`, `Community 233`, `Community 235`, `Community 113`, `Community 883`, `Community 117`, `Community 885`, `Community 504`, `Community 505`, `Community 893`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `AdminLayoutInner()` connect `Community 932` to `Community 424`, `Community 4`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 424` to `Community 289`, `Community 932`, `Community 9`, `Community 203`, `Community 235`, `Community 110`, `Community 912`, `Community 113`, `Community 822`, `Community 31`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
...
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.026859504132231406 - nodes in this community are weakly interconnected._