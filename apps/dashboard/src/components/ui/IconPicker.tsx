...
const selectedIconPickerButtonClass =
  "border-[var(--color-primary)] bg-[color-mix(in_srgb,var(--color-primary)_30%,transparent)] text-white hover:border-[var(--color-primary)] hover:bg-[color-mix(in_srgb,var(--color-primary)_38%,transparent)] hover:text-white";
