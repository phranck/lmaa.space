  ...
  return (
    <div>
      ...
      <button
        ...
        className={`w-full flex items-center justify-between px-3 py-1.5 border rounded-control text-sm text-left bg-[var(--ds-form-control-bg,var(--ds-input-bg))] transition-colors ${
          open
